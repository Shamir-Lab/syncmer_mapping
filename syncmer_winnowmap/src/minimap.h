...
typedef struct {
	int32_t b, w, k, flag;
	int s ,pos1,pos2,pos3,pos4; double ds;
...
mm_idx_t *mm_idx_build(const char *fn, int w, int k, int flag, int n_threads,double ds,int smer_size,int pos1,int pos2,int pos3,int pos4);
