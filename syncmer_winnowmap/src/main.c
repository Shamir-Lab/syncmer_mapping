...
static ko_longopt_t long_options[] = {
	{ "pos1", 			ko_required_argument, 403 } ,
	{ "pos2", 			ko_required_argument, 404 } ,
	{ "pos3", 			ko_required_argument, 405 } ,
	{ "pos4", 			ko_required_argument, 406 } ,
	{ "downsample",		ko_required_argument, 401 } ,
	{ "s-mer",			ko_required_argument, 402 } ,
...
int main(int argc, char *argv[])
{
	...
	while ((c = ketopt(&o, argc, argv, 1, opt_str, long_options)) >= 0) {
		...
		else if (c == 401) ipt.ds = atof(o.arg); //downsampling factor
		else if (c == 402) ipt.s = atoi(o.arg); //s-mer size
		else if (c == 403) ipt.pos1 = atoi(o.arg); //positions
		else if (c == 404) ipt.pos2 = atoi(o.arg); //positions
		else if (c == 405) ipt.pos3 = atoi(o.arg); //positions
		else if (c == 406) ipt.pos4 = atoi(o.arg); //positions
	...
	if (argc == o.ind || fp_help == stdout) {
		fprintf(fp_help, "winnowmap is built on top of minimap2, while modifying its minimizer sampling and indexing procedures\n");
